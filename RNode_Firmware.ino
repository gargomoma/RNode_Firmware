...
void setup() {
  ...
  #if BOARD_MODEL != BOARD_RAK4631 && BOARD_MODEL != BOARD_PROMICRO && BOARD_MODEL != BOARD_HELTEC_T114 && BOARD_MODEL != BOARD_TECHO && BOARD_MODEL != BOARD_T3S3 && BOARD_MODEL != BOARD_TBEAM_S_V1 && BOARD_MODEL != BOARD_HELTEC32_V4
